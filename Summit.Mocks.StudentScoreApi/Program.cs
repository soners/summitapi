...
app.MapGet("/api/students/{studentId}/score", ([FromRoute] string studentId) => studentScores.TryGetValue(studentId, out var studentScore) ? Results.Ok((object?)studentScore) : Results.NotFound("STUDENT_SCORE_NOT_FOUND"));
